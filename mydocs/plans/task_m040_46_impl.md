...
- raw response field는 Desktop에서 검증된 `profile`, `stats.summary`, `stats.daily_usage_buckets`, `stats.activity_insights`, `metadata.stats_error` category만 읽는다. Private stats summary/daily bucket은 상태 판단 외 output usage에 복사하지 않는다.
