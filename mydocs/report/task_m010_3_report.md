...
| `mydocs/working/task_m010_3_stage1.md` ~ `task_m010_3_stage6.md` | 단계별 검증과 판단 기록 | 하이퍼-워터폴 작업 문서 |
...
| `mydocs/working/task_m010_3_stage{N}.md` | `mydocs/working/` | `mydocs/working/task_m010_3_stage1.md` ~ `task_m010_3_stage6.md` | OK | 단계 보고서 위치와 파일명 규칙 일치 |
...
- Codex Desktop profile streak는 원격 profile/API 또는 account-level 산식으로 보이며, local UTC session JSONL streak와 일치한다고 보장하지 않는다.
...
- 별도 후속: Codex Desktop profile/API streak 산식과 local session JSONL streak alignment 검토
